...
extern "C" {
	...
	__declspec(dllexport) Vec4 Vec4Subtract(Vec4 a, const Vec4 b);
	__declspec(dllexport) Vec4 Vec4Multiply(Vec4 a, const Vec4 b);
	__declspec(dllexport) Vec4 Vec4Divide(Vec4 a, const Vec4 b);

	__declspec(dllexport) Vec4 Vec4MultiplyF(const Vec4 a, float v);
	__declspec(dllexport) Vec4 Vec4DivideF(const Vec4 a, float v);
